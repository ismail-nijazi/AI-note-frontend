...
import { PenTool, Eye, EyeOff, Mail, Lock, User, CheckCircle } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to Whiteboard Notes. Let's start organizing your ideas!",
      });
      navigate('/app');
      setIsLoading(false);
    }, 1000);
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Start organizing your ideas with a free account
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <div className="mt-6">
              ...
              >
                ...
                Try Demo First (No Account Needed)
              </Button>
            </div>
